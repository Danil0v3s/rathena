...
#define UNWRAP                                   \
	...
	void PlayerHost::warp_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (mname == "Random") {
			...
			if (mi != 0)
				pc_setpos(&sd, mi, x, y, CLR_TELEPORT);
		}
	}
	...
	void PlayerHost::giveItem_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (amount <= 0 || nameid == 0)
			return;
		if (item_db.find(nameid) == nullptr)
			return;
		struct item it = {};
		it.nameid = nameid;
		it.identify = 1;
	...
	void PlayerHost::consumeItem_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (idx >= 0)
			pc_delitem(&sd, idx, 1, 0, 0, LOG_TYPE_CONSUME);
	}
	...
	void PlayerHost::getEquipCardCount_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		for (int i = 0; i < MAX_SLOTS; ++i) {
			if (sd.inventory.u.items_inventory[idx].card[i] != 0)
				++c;
		}
		ret_int(info, c);
	}
	void PlayerHost::getEquipCardId_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		int idx = pc_checkequip(&sd, equip_bitmask[slot]);
		if (idx < 0 || cardSlot < 0 || cardSlot >= MAX_SLOTS) {
			ret_int(info, 0);
			return;
		}
	...
	void PlayerHost::delEquip_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		int idx = pc_checkequip(&sd, equip_bitmask[slot]);
		if (idx >= 0)
			pc_delitem(&sd, idx, 1, 0, 0, LOG_TYPE_SCRIPT);
	}
	...
	void PlayerHost::breakEquip_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		int idx = pc_checkequip(&sd, equip_bitmask[slot]);
		if (idx >= 0)
			sd.inventory.u.items_inventory[idx].attribute = 1;
	}
	...
	void PlayerHost::setCart_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_setcart(&sd, int_arg(info, 0, 1));
	}
	void PlayerHost::setFalcon_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_setfalcon(&sd, bool_arg(info, 0, true) ? 1 : 0);
	}
	void PlayerHost::setRiding_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_setriding(&sd, bool_arg(info, 0, true) ? 1 : 0);
	}
	...
	void PlayerHost::checkCart_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_iscarton(&sd));
	}
	void PlayerHost::checkFalcon_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_isfalcon(&sd));
	}
	void PlayerHost::checkRiding_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_isriding(&sd));
	}
	void PlayerHost::checkDragon_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_isridingdragon(&sd));
	}
	void PlayerHost::checkMadogear_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_ismadogear(&sd));
	}
	void PlayerHost::checkWug_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_iswug(&sd));
	}
	void PlayerHost::isMounting_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, sd.sc.getSCE(SC_ALL_RIDING) != nullptr);
	}
	...
	void PlayerHost::isDead_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, pc_isdead(&sd));
	}
	...
	void PlayerHost::resetStatus_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_resetstate(&sd);
	}
	void PlayerHost::resetSkill_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_resetskill(&sd, 1);
	}
	void PlayerHost::resetFeel_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_resetfeel(&sd);
	}
	void PlayerHost::resetHate_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		pc_resethate(&sd);
	}
	...
	void PlayerHost::openMail_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_Mail_window(sd.fd, 0);
	}
	void PlayerHost::openAuction_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_Auction_openwindow(&sd);
	}
	void PlayerHost::openRefineUi_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_refineui_open(&sd);
	}
	void PlayerHost::openStylist_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_ui_open(sd, OUT_UI_STYLIST, 0);
	}
	void PlayerHost::openDressRoom_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_dressing_room(sd);
	}
	void PlayerHost::openRoulette_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
	...
	void PlayerHost::openEnchantGrade_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
	...
	void PlayerHost::openLaphineSynthesis_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (syn)
			clif_laphine_synthesis_open(&sd, syn);
	}
	void PlayerHost::openLaphineUpgrade_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (upg)
			clif_laphine_upgrade_open(&sd, upg);
	}
	...
	void PlayerHost::specialPopup_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_specialpopup(sd, int_arg(info, 0));
	}
	...
	void PlayerHost::countSpiritBall_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.spiritball);
	}
	...
	void PlayerHost::getFame_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.fame);
	}
	void PlayerHost::addFame_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		sd.status.fame += int_arg(info, 0);
	}
	...
	void PlayerHost::adopt_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (!baby) {
			ret_int(info, ADOPT_CHARACTER_NOT_FOUND);
			return;
		}
	...
	void PlayerHost::getPartnerId_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.partner_id);
	}
	void PlayerHost::getMotherId_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.mother);
	}
	void PlayerHost::getFatherId_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.father);
	}
	void PlayerHost::getChildId_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.child);
	}
	...
	void PlayerHost::guildHasPermission_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		if (perm == 0 || (perm & GUILD_PERM_ALL) == 0) {
			ret_bool(info, false);
			return;
		}
		if (!sd.guild) {
	...
	void PlayerHost::charInfo_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		switch (t) {
			...
			case 3: {
				auto mn = map_mapid2mapname(sd.m);
				ret_str(info, mn ? mn : "");
				break;
			}
	...
	void PlayerHost::charId4Type_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_int(info, sd.status.char_id);
	}
	void PlayerHost::charIp_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		if (sd.fd < 0 || !session[sd.fd]) {
			ret_str(info, "");
			return;
		}
	...
	void PlayerHost::kick_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		clif_GM_kick(nullptr, &sd);
	}
	void PlayerHost::ignoreTimeout_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		sd.state.ignoretimeout = bool_arg(info, 0) ? 1 : 0;
	}
	void PlayerHost::autoLoot_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		if (has(info, 0))
			sd.state.autoloot = int_arg(info, 0);
	...
	void PlayerHost::jobCanEnterMap_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		...
		ret_bool(info, pc_job_can_entermap(static_cast<e_job>(jobid), m, pc_get_group_level(&sd)));
	}
	void PlayerHost::checkVending_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, sd.state.vending != 0);
	}
	void PlayerHost::checkChatting_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, sd.chatID != 0);
	}
	...
	void PlayerHost::clanLeave_cb(const v8::FunctionCallbackInfo<v8::Value>& info) {
		UNWRAP;
		ret_bool(info, clan_member_leave(sd, sd.status.clan_id, sd.status.account_id, sd.status.char_id));
	}
...
#define BIND(name) args::bind_method<PlayerHost>(iso, ctx, obj, this, #name, &PlayerHost::name##_cb)
		...
		BIND(getEquipId);
		BIND(getEquipName);
		BIND(getEquipUniqueId);
		BIND(getEquipRefine);
		BIND(getEquipWeaponLv);
		BIND(getEquipArmorLv);
		BIND(getEquipCardCount);
		BIND(getEquipCardId);
		BIND(getEnchantGrade);
		BIND(isEquipped);
		BIND(isEquipEnableRef);
		BIND(getItemPos);
		BIND(equip);
		BIND(autoEquip);
		BIND(unequip);
		...
		BIND(itemSkill);
		BIND(getSkillList);
		BIND(skillPointCount);
		BIND(basicSkillCheck);
		BIND(setLook);
		BIND(changeLook);
		BIND(getLook);
		BIND(setFont);
		...
		BIND(getStatus);
		BIND(isDead);
		BIND(recalculateStat);
		BIND(needStatusPoint);
		BIND(resetStatus);
		BIND(resetSkill);
		BIND(resetFeel);
		BIND(resetHate);
		...
		BIND(openRoulette);
		BIND(openQuestUi);
		BIND(openEnchantGrade);
		BIND(openLaphineSynthesis);
		BIND(openLaphineUpgrade);
		BIND(openItemEnchant);
		BIND(openItemReform);
		BIND(specialPopup);
		BIND(openTips);
		BIND(readBook);
