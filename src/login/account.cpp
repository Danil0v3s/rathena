...
static bool account_db_sql_load_str(AccountDB* self, struct mmo_account* acc, const char* userid) {
	...
	if (SQL_ERROR == Sql_Query(sql_handle, "SELECT `account_id` FROM `%s` WHERE `userid`= %s '%s'", db->account_db, (db->case_sensitive ? "BINARY" : ""), esc_userid)) {
		Sql_ShowDebug(sql_handle);
		return false;
	}
...
static bool account_db_sql_iter_next(AccountDBIterator* self, struct mmo_account* acc) {
	...
	// get next account ID
	if (SQL_ERROR == Sql_Query(sql_handle, "SELECT `account_id` FROM `%s` WHERE `account_id` > '%d' ORDER BY `account_id` ASC LIMIT 1", db->account_db, iter->last_account_id)) {
		Sql_ShowDebug(sql_handle);
		return false;
	}
...
static bool mmo_auth_fromsql(AccountDB_SQL* db, struct mmo_account* acc, uint32 account_id) {
	...
	acc->group_id = (uint32)atoi(data);
	Sql_GetData(sql_handle, 6, &data, nullptr);
	acc->state = (uint32)strtoul(data, nullptr, 10);
	...
	acc->logincount = (uint32)strtoul(data, nullptr, 10);
	Sql_GetData(sql_handle, 10, &data, nullptr);
	safestrncpy(acc->lastlogin, data == nullptr ? "" : data, sizeof(acc->lastlogin));
	Sql_GetData(sql_handle, 11, &data, nullptr);
	safestrncpy(acc->last_ip, data, sizeof(acc->last_ip));
	Sql_GetData(sql_handle, 12, &data, nullptr);
	safestrncpy(acc->birthdate, data == nullptr ? "" : data, sizeof(acc->birthdate));
	Sql_GetData(sql_handle, 13, &data, nullptr);
	acc->char_slots = (uint8)atoi(data);
	Sql_GetData(sql_handle, 14, &data, nullptr);
	safestrncpy(acc->pincode, data, sizeof(acc->pincode));
	Sql_GetData(sql_handle, 15, &data, nullptr);
	acc->pincode_change = atol(data);
#ifdef VIP_ENABLE
	Sql_GetData(sql_handle, 16, &data, nullptr);
	acc->vip_time = atol(data);
	Sql_GetData(sql_handle, 17, &data, nullptr);
	...
	do {
		...
		if (is_new) { // insert into account table
...
#endif
			                       db->account_db) ||
			    SQL_SUCCESS != stmt.BindParam(0, SQLDT_INT32, (void*)&acc->account_id, sizeof(acc->account_id)) || SQL_SUCCESS != stmt.BindParam(1, SQLDT_STRING, (void*)acc->userid, strlen(acc->userid)) || SQL_SUCCESS != stmt.BindParam(2, SQLDT_STRING, (void*)acc->pass, strlen(acc->pass)) || SQL_SUCCESS != stmt.BindParam(3, SQLDT_ENUM, (void*)&acc->sex, sizeof(acc->sex)) || SQL_SUCCESS != stmt.BindParam(4, SQLDT_STRING, (void*)&acc->email, strlen(acc->email)) || SQL_SUCCESS != stmt.BindParam(5, SQLDT_INT32, (void*)&acc->group_id, sizeof(acc->group_id)) || SQL_SUCCESS != stmt.BindParam(6, SQLDT_UINT32, (void*)&acc->state, sizeof(acc->state)) || SQL_SUCCESS != stmt.BindParam(7, SQLDT_LONG, (void*)&acc->unban_time, sizeof(acc->unban_time)) || SQL_SUCCESS != stmt.BindParam(8, SQLDT_INT32, (void*)&acc->expiration_time, sizeof(acc->expiration_time)) || SQL_SUCCESS != stmt.BindParam(9, SQLDT_UINT32, (void*)&acc->logincount, sizeof(acc->logincount)) || SQL_SUCCESS != stmt.BindParam(10, acc->lastlogin[0] ? SQLDT_STRING : SQLDT_NULL, (void*)&acc->lastlogin, strlen(acc->lastlogin)) || SQL_SUCCESS != stmt.BindParam(11, SQLDT_STRING, (void*)&acc->last_ip, strlen(acc->last_ip)) || SQL_SUCCESS != stmt.BindParam(12, acc->birthdate[0] ? SQLDT_STRING : SQLDT_NULL, (void*)&acc->birthdate, strlen(acc->birthdate)) || SQL_SUCCESS != stmt.BindParam(13, SQLDT_UCHAR, (void*)&acc->char_slots, sizeof(acc->char_slots)) || SQL_SUCCESS != stmt.BindParam(14, SQLDT_STRING, (void*)&acc->pincode, strlen(acc->pincode)) || SQL_SUCCESS != stmt.BindParam(15, SQLDT_LONG, (void*)&acc->pincode_change, sizeof(acc->pincode_change))
#ifdef VIP_ENABLE
			    || SQL_SUCCESS != stmt.BindParam(16, SQLDT_LONG, (void*)&acc->vip_time, sizeof(acc->vip_time)) || SQL_SUCCESS != stmt.BindParam(17, SQLDT_INT32, (void*)&acc->old_group, sizeof(acc->old_group))
#endif
			...
			if (SQL_SUCCESS != stmt.Prepare(
			    ...
			    SQL_SUCCESS != stmt.BindParam(0, SQLDT_STRING, (void*)acc->userid, strlen(acc->userid)) || SQL_SUCCESS != stmt.BindParam(1, SQLDT_STRING, (void*)acc->pass, strlen(acc->pass)) || SQL_SUCCESS != stmt.BindParam(2, SQLDT_ENUM, (void*)&acc->sex, sizeof(acc->sex)) || SQL_SUCCESS != stmt.BindParam(3, SQLDT_STRING, (void*)acc->email, strlen(acc->email)) || SQL_SUCCESS != stmt.BindParam(4, SQLDT_INT32, (void*)&acc->group_id, sizeof(acc->group_id)) || SQL_SUCCESS != stmt.BindParam(5, SQLDT_UINT32, (void*)&acc->state, sizeof(acc->state)) || SQL_SUCCESS != stmt.BindParam(6, SQLDT_LONG, (void*)&acc->unban_time, sizeof(acc->unban_time)) || SQL_SUCCESS != stmt.BindParam(7, SQLDT_LONG, (void*)&acc->expiration_time, sizeof(acc->expiration_time)) || SQL_SUCCESS != stmt.BindParam(8, SQLDT_UINT32, (void*)&acc->logincount, sizeof(acc->logincount)) || SQL_SUCCESS != stmt.BindParam(9, acc->lastlogin[0] ? SQLDT_STRING : SQLDT_NULL, (void*)&acc->lastlogin, strlen(acc->lastlogin)) || SQL_SUCCESS != stmt.BindParam(10, SQLDT_STRING, (void*)&acc->last_ip, strlen(acc->last_ip)) || SQL_SUCCESS != stmt.BindParam(11, acc->birthdate[0] ? SQLDT_STRING : SQLDT_NULL, (void*)&acc->birthdate, strlen(acc->birthdate)) || SQL_SUCCESS != stmt.BindParam(12, SQLDT_UCHAR, (void*)&acc->char_slots, sizeof(acc->char_slots)) || SQL_SUCCESS != stmt.BindParam(13, SQLDT_STRING, (void*)&acc->pincode, strlen(acc->pincode)) || SQL_SUCCESS != stmt.BindParam(14, SQLDT_LONG, (void*)&acc->pincode_change, sizeof(acc->pincode_change))
#ifdef VIP_ENABLE
			    || SQL_SUCCESS != stmt.BindParam(15, SQLDT_LONG, (void*)&acc->vip_time, sizeof(acc->vip_time)) || SQL_SUCCESS != stmt.BindParam(16, SQLDT_INT32, (void*)&acc->old_group, sizeof(acc->old_group))
#endif
			    || SQL_SUCCESS != stmt.Execute()) {
				SqlStmt_ShowDebug(stmt);
				break;
