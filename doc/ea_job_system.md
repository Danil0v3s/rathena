...
*Last updated 2026-01-02 by Skotlex (upstream `doc/` header)*
...
Then getting the third job versions:
...
And finally the fourth job versions:

```
EAJ_SWORDMAN|EAJL_2_1|EAJL_THIRD|EAJL_FOURTH	-> EAJ_DRAGON_KNIGHT
EAJ_SWORDMAN|EAJL_2_2|EAJL_THIRD|EAJL_FOURTH	-> EAJ_IMPERIAL_GUARD
```
...
EAJ_SWORDMAN|EAJL_2_2|EAJL_THIRD|EAJL_UPPER	-> EAJ_ROYAL_GUARD_T
```
