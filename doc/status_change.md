...
*Last updated 20241024 by rAthena Dev Team (upstream `doc/` header)*
...
### SC_WINKCHARM (EFST_DC_WINKCHARM)

```
desc: Can't cast spells. Can't attack the charmer. Only works on non-players.
val1: Skill level
