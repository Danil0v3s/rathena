...
*Last updated 20201006 by rAthena Dev Team (upstream `doc/` header)*
...
DamageTaken: Rate at which the monster will receive damage from players.
...
Ai: Aegis Monster Type behavior. Full explanation can be found in 'doc/mob_db_mode_list.md'.

Class: Aegis Monster Class Type behavior. Full explanation can be found in 'doc/mob_db_mode_list.md'.

Modes: Behaviour that isn't defined by AI or Class of the monster. Full explanation can be found in 'doc/mob_db_mode_list.md'.
